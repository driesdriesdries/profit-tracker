...
<div class="container py-5">
    ...
    <!-- Second Row: Table and Mock Text -->
    <div class="row g-4 mt-4">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="<?php echo $percentage_class; ?>">
        ...
        <!-- Right Column: Mock Text -->
        <div class="col-lg-4">
            <div class="p-4 bg-light rounded shadow h-100">
                <h5>Placeholder Content</h5>
                <p>This is a placeholder block. You can insert stats, notes, or additional charts here later.</p>
            </div>
        </div>
    </div>
</div>
